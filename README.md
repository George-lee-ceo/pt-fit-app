...
// --- Firebase 설정 (대표님의 '비밀 열쇠'로 연결 완료) ---
const firebaseConfig = {
  apiKey: "AIzaSyBQ1M-JYobvQ-6PNj5hOXcXr_kRjilOSAQ",
  authDomain: "pt-fit-app.firebaseapp.com",
  projectId: "pt-fit-app",
  storageBucket: "pt-fit-app.firebasestorage.app",
  messagingSenderId: "1076357610629",
  appId: "1:1076357610629:web:a95310c54c4f4a7390fdec"
};
// const appId = typeof __app_id !== 'undefined' ? __app_id : 'pt-fit-app-default'; // 이 부분은 이제 필요 없습니다.
